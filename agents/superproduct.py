...
Règles:
- Réagis au DERNIER propos (question, objection, ou next-step).
- 2 phrases max (≤ 50 mots). Pas de blabla, un seul angle utile.
- Cite la personne au début.
- Si rien d'utile: "Je passe."
